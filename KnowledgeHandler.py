...
class KnowledgeHandler:
    ...
    def question_mapping(self):
        text = {
            "Akreditasi Jurusan Film apa nih?": "[0[Akreditasi]] [3[Jurusan Film]]",
            "Gelar di Finance apa sih?": "[0[Gelar]] [3[Finance]]",
            "Lulusan Akuntansi dapet gelar apa?": "[3[Akuntansi]] [0[gelar]]",
            "Program Business Creation di lokasi mana?": "[3[Business Creation]] [2[lokasi]]",
            "Bisnis Digital berapa lama sih?": "[3[Bisnis Digital]] [0[lama]]",
            "Lulusan Animasi bisa kerja apa aja?": "[3[Animasi]] [0[bisa kerja]]",
            "Apa fokus utama program Taxation?": "[0[fokus utama]] [3[Taxation]]",
            "Apa akreditasi program Fashion?": "[0[akreditasi]] [3[Fashion]]",
            "Jurusan Finance waktu berapa lama?": "[3[Finance]] [0[berapa lama]]",
            "Peluang karier jurusan International Business?": "[0[karier]] [3[International Business]]",

            "Gelar akademik apa untuk lulusan Finance di BINUS University?": "[0[Gelar akademik]] [3[Finance]]",
            "Karier potensial buat lulusan DKV tuh apa aja ya?": "[0[Karier]] [3[DKV]]",
            "Gimana sih program Entrepreneurship bikin mahasiswa jadi pengusaha?": "[3[Entrepreneurship]]",
            "Program Bisnis Digital di BINUS ngajarin skill apa aja?": "[3[Bisnis Digital]] [0[skill]]",
            "Fasilitas apa yang tersedia bagi mahasiswa Fashion di BINUS University?": "[0[Fasilitas]] [3[Fashion]]",
            "Peluang karier lulusan Akuntansi tuh apa aja sih?": "[0[karier]] [3[Akuntansi]]",
            "Akreditasi Entrepreneurship Business Creation di BINUS apa?": "[0[Akreditasi]] [3[Entrepreneurship]] [1[Business Creation]]",
            "Program Taxation kelarnya butuh waktu berapa lama?": "[3[Taxation]] [0[waktu berapa lama]]",
            "Karier buat anak Desain Interior tuh bisa ke mana aja?": "[0[Karier]] [3[Desain Interior]]",
            "Bagaimana BINUS mempersiapkan mahasiswa Bisnis Digital untuk karier masa depan?": "[3[Bisnis Digital]] [0[karier]]",

            "Bagaimana program Desain Komunikasi Visual di BINUS University mengintegrasikan teknologi dan kreativitas?": "[3[Desain Komunikasi Visual]]",
            "Peluang karier apa yang tersedia bagi lulusan program Desain Interior di BINUS University?": "[0[karier]] [3[Desain Interior]]",
            "Bagaimana jurusan Film di BINUS University mempersiapkan mahasiswa untuk karier di industri perfilman?": "[3[Film]] [0[karier]]",
            "Jelaskan apa pentingnya magang dalam program Desain Komunikasi Visual di BINUS?": "[0[magang]] [3[Desain Komunikasi Visual]]",
            "Peluang karier apa yang tersedia bagi lulusan program Finance di BINUS University?": "[0[Peluang karier]] [3[Finance]]",
            "Bagaimana program Taxation di BINUS University membekali mahasiswa dengan teknologi pajak terbaru?": "[3[Taxation]]",
            "Apa sih bedanya program Bisnis Digital BINUS sama program bisnis tradisional?": "[3[Bisnis Digital]] [3[bisnis tradisional]]",
            "Jalur karier apa yang tersedia bagi lulusan program Fashion di BINUS University?": "[0[Jalur karier]] [3[Fashion]]",
            "Gimana program Entrepreneurship BINUS ngebentuk mindset buat jadi pengusaha masa depan?": "[3[Entrepreneurship]]",
            "Bagaimana program Akuntansi di BINUS University mempersiapkan mahasiswa menghadapi tantangan keuangan di dunia nyata?": "[3[Akuntansi]]"
        }
        return text

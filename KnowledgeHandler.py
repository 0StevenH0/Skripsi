...
class KnowledgeHandler:
    ...
    def question_mapping(self):
        text = {
            "Fasilitas unik apa saja yang tersedia dalam program Fashion di BINUS University yang mendukung mahasiswa dalam studi mereka?" : "[6[Fasilitas]] unik apa saja yang tersedia dalam [6[program Fashion]] di BINUS University yang mendukung mahasiswa dalam studi mereka?",
            "Bisakah Anda menjelaskan struktur program (2+1+1) pada jurusan Fashion di BINUS University dan bagaimana manfaatnya bagi karier mahasiswa?" : "Bisakah Anda menjelaskan struktur [6[program]] (2+1+1) pada jurusan [3[Fashion]] di BINUS University dan bagaimana manfaatnya bagi [0[karier]] mahasiswa?",
            "Kompetensi inti apa aja yang ditekankan dalam program Desain Interior di BINUS University untuk mastiin lulusan siap kerja di industr?" : "Kompetensi inti apa aja ya yang ditekankan dalam [6[program Desain Interior]] di BINUS University untuk mastiin lulusan siap kerja di industri?",
            "Bisakah Anda menjelaskan peluang karier bagi mahasiswa lulusan program Desain Komunikasi Visual di BINUS University, terutama di bidang animasi?" : "Bisakah Anda menjelaskan peluang [0[karier]] bagi mahasiswa lulusan [6[program Desain Komunikasi Visual]] di BINUS University, terutama di bidang [3[animasi]]?",
            "Bagaimana program International Business Management di BINUS University mempersiapkan mahasiswa untuk berkarier di perusahaan multinasional?" : "Bagaimana [6[program International Business Management]] di BINUS University mempersiapkan mahasiswa untuk [0[berkarier]] di perusahaan multinasional?",
            "Bagaimana prospek karier sebagai konsultan pajak setelah lulus dari program Perpajakan di BINUS University?" : "Bagaimana [0[prospek karier]] sebagai konsultan pajak setelah lulus dari [6[program Perpajakan]] di BINUS University?",
            "Apa perbedaan utama antara program Bisnis Digital di BINUS University dengan program bisnis tradisional dalam hal hasil karier?" : "Apa perbedaan utama antara [6[program Bisnis Digital]] di BINUS University dengan [6[program bisnis tradisional]] dalam hal hasil [0[karier]]?",
            "Apa peran program enrichment seperti magang dan kunjungan lapangan dalam kurikulum program Desain Interior di BINUS University?" : "Apa peran [6[program]] enrichment seperti magang dan kunjungan lapangan dalam kurikulum [6[program Desain Interior]] di BINUS University?",
            "Bisakah Anda memberikan gambaran tentang bagaimana program Desain Komunikasi Visual di BINUS University mengintegrasikan budaya lokal dan teknologi dalam kurikulumnya?" : "Bisakah Anda memberikan [0[gambaran]] tentang bagaimana [6[program Desain Komunikasi Visual]] di BINUS University mengintegrasikan budaya lokal dan teknologi dalam kurikulumnya?",
            "Keterampilan dan pengetahuan apa saja yang akan dikembangkan oleh mahasiswa dalam program Bisnis Digital di BINUS University untuk menjadi pengusaha digital yang sukses?" : "Keterampilan dan pengetahuan apa saja yang akan dikembangkan oleh mahasiswa dalam [6[program Bisnis Digital]] di BINUS University untuk menjadi pengusaha digital yang sukses?",

            "Akreditasi apa yang dimiliki oleh program Perpajakan di BINUS University?" : "[0[Akreditasi]] apa yang dimiliki oleh [6[program Perpajakan]] di BINUS University?",
            "Karier potensial mantul apa saja yang bisa diambil oleh lulusan program Akuntansi di BINUS University?" : "[0[Karier]] potensial mantul apa saja yang bisa diambil oleh lulusan [6[program Akuntansi]] di BINUS University?",
            "Berapa lama waktu yang dibutuhkan untuk menyelesaikan program Fashion di BINUS University?" : "Berapa [0[lama]] waktu yang dibutuhkan untuk menyelesaikan [6[program Fashion]] di BINUS University?",
            "Gelar akademik apa yang diberikan kepada lulusan program Desain Interior di BINUS University?" : "[0[Gelar]] akademik apa yang diberikan kepada lulusan [6[program Desain Interior]] di BINUS University?",
            "Apa saja peluang karier di bidang bisnis digital setelah lulus dari BINUS University?" : "Apa saja peluang [0[karier]] di bidang [3[bisnis digital]] setelah lulus dari BINUS University?",
            "Bagaimana status akreditas program Desain Komunikasi Visual di BINUS University?" : "Bagaimana status [0[akreditasi]] [6[program Desain Komunikasi Visual]] di BINUS University?",
            "Jalur karier apa saja yang tersedia bagi lulusan program Fashion di BINUS University?" : "Jalur [0[karier]] apa saja yang tersedia bagi lulusan [6[program Fashion]] di BINUS University?",
            "Bagaimana prgram International Business Management di BINUS University mempersiapkan mahasiswa untuk karier global?" : "Bagaimana [6[program International Business Management]] di BINUS University mempersiapkan mahasiswa untuk [0[karier]] global?",
            "Karier potensial apa saja yang tersedia bagi lulusan program Perpajakan di BINUS University?" : "[0[Karier]] potensial apa saja yang tersedia bagi lulusan [6[program Perpajakan]] di BINUS University?",
            "Berapa lama durasi program Akuntansi di BINUS University? supaya saya tidak FOMO" : "Berapa [0[lama durasi]] [6[program Akuntansi]] di BINUS University?",

            "Berapa lama durasi program Perpajakan di BINUS University?" : "Berapa [0[lama durasi]] [6[program Perpajakan]] di BINUS University?",
            "Akreditasi apa yang dimiliki program Desain Interior di BINUS University?" : "[0[Akreditasi]] apa yang dimiliki [6[program Desain Interior]] di BINUS University?",
            "Gelar akademik apa yang diberikan kepada lulusan Fashion di BINUS University?" : "[0[Gelar]] akademik apa yang diberikan kepada lulusan [3[Fashion]] di BINUS University?",
            "Gelar apa yang Anda dapatkan dari program Bisnis Digital di BINUS University?" : "[0[Gelar]] apa yang Anda dapatkan dari [6[program Bisnis Digital]] di BINUS University?",
            "Apa aja karier potensial untuk lulusan Desain Komunikasi Visual BINUS University?" : "Apa aja [0[karier]] potensial untuk lulusan [3[Desain Komunikasi Visual]] BINUS University?",
            "Apa prospek karier buat lulusan Fashion BINUS University?" : "Apa prospek [0[karier]] untuk lulusan [3[Fashion]] BINUS University?",
            "Apa akreditasi program Film di BINUS University?" : "Apa [0[akreditasi]] [6[program Film]] di BINUS University?",
            "Apa pilihan karier bagi lulusan program Animasi di BINUS University? Carikan saya program yang bisa santuy" : "Apa pilihan [0[karier]] bagi lulusan [6[program Animasi]] di BINUS University? Carikan saya [6[program]] yang bisa santuy",
            "Berapa lama program Film di BINUS University?" : "Berapa [0[lama]] [6[program Film]] di BINUS University?",
            "Gelar akademik apa yang diberikan kepada lulusan Akuntansi di BINUS University?" : "[0[Gelar]] akademik apa yang diberikan kepada lulusan [3[Akuntansi]] di BINUS University?"
        }
        return text

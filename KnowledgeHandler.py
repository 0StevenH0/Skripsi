...
class KnowledgeHandler:
    ...
    def question_mapping(self):
        text = {
            ...
            "Kompetensi inti apa saja yang ditekankan dalam program Desain Interior di BINUS University untuk memastikan lulusan siap kerja di industri?" : "Kompetensi inti apa saja yang ditekankan dalam [6[program Desain Interior]] di BINUS University untuk memastikan lulusan siap kerja di industri?",
            ...
            "Karier potensial apa saja yang bisa diambil oleh lulusan program Akuntansi di BINUS University?" : "[0[Karier]] potensial apa saja yang bisa diambil oleh lulusan [6[program Akuntansi]] di BINUS University?",
            ...
            "Bagaimana status akreditasi program Desain Komunikasi Visual di BINUS University?" : "Bagaimana status [0[akreditasi]] [6[program Desain Komunikasi Visual]] di BINUS University?",
            ...
            "Bagaimana program International Business Management di BINUS University mempersiapkan mahasiswa untuk karier global?" : "Bagaimana [6[program International Business Management]] di BINUS University mempersiapkan mahasiswa untuk [0[karier]] global?",
            ...
            "Berapa lama durasi program Akuntansi di BINUS University?" : "Berapa [0[lama durasi]] [6[program Akuntansi]] di BINUS University?",
            ...
            "Apa saja karier potensial untuk lulusan Desain Komunikasi Visual BINUS University?" : "Apa saja [0[karier]] potensial untuk lulusan [3[Desain Komunikasi Visual]] BINUS University?",
            "Apa prospek karier untuk lulusan Fashion BINUS University?" : "Apa prospek [0[karier]] untuk lulusan [3[Fashion]] BINUS University?",
            ...
            "Apa pilihan karier bagi lulusan program Animasi di BINUS University?" : "Apa pilihan [0[karier]] bagi lulusan [6[program Animasi]] di BINUS University?"
        }
        return text

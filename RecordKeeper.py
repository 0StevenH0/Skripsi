...
def persist_result(request, return_query, answers):
    ...
    write_to_csv(
        app_settings.retrieval_result_file_name, retrieval_headers, retrieval_row
    )


def Record(file_name: str):
    """
    Decorator util to saves input and output of a func to class
    Args:
        file_name : name of file

    Returns:
        wrapped class returns
    """
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            output_data = result
            headers = ["Timestamp", "Input", "Output"]
